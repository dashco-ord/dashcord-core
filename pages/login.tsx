        ...
        <div className='flex flex-col justify-center items-center lg:h-screen'>
            <div className='text-sm font-medium text-center text-black border-b border-gray-300 '>
                <ul className='flex flex-wrap -mb-px'>
                    <li
                        className={`mr-1 inline-block p-4 rounded-t-lg border-b-2 border-transparent cursor-pointer ${view == UserRole.STUDENT
                    ...
                    <li
                        className={`mr-1 inline-block p-4 rounded-t-lg border-b-2 border-transparent cursor-pointer ${view == UserRole.TG
                            ? "text-purple-700 border-purple-700"
                            : "hover:text-purple-700 hover:border-purple-700"
                            }`}
                        onClick={() => {
                    ...
                    <li
                        className={`mr-1 inline-block p-4 rounded-t-lg border-b-2 border-transparent cursor-pointer ${view == UserRole.INCHARGE
                            ? "text-purple-700 border-purple-700"
                            : "hover:text-purple-700 hover:border-purple-700"
                            }`}
                        onClick={() => {
                    ...
                    <li
                        className={`mr-1 inline-block p-4 rounded-t-lg border-b-2 border-transparent cursor-pointer ${view == UserRole.TNP
                            ? "text-purple-700 border-purple-700"
                            : "hover:text-purple-700 hover:border-purple-700"
                            }`}
                        onClick={() => {
                    ...
                    <li
                        className={`mr-1 inline-block p-4 rounded-t-lg border-b-2 border-transparent cursor-pointer ${view == UserRole.HOD
                            ? "text-purple-700 border-purple-700"
                            : "hover:text-purple-700 hover:border-purple-700"
                            }`}
                        onClick={() => {
