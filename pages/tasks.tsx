...
const TasksPage = ({ tasks }: taskProps) => {
    return (
        <StudentsLayout>
            <div className="w-full bg-white p-4 rounded lg:min-w-[75rem]">
                                ...
                                <div key={task.id}>
                                    <div className="flex flex-col break-words min-h-[13rem] w-[25rem] font-semibold mt-10 mr-10 border border-black p-5 rounded-lg">
                                        <div className="flex items-center">
                                            ...
                                            <div
                                                className={`ml-auto border p-1 px-2 w-fit text-sm rounded-full ${task.taskStatus == Status.InProgress
