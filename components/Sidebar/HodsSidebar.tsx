...
const HodSidebar = () => {
  ...
  return (
    <div className="flex flex-col pt-8 pb-5 items-center w-16 h-screen bg-white text-3xl px-7 overflow-y-scroll">
      ...
      <div
        className={`my-5 ${
          isActive(`/hod`) ? "bg-purple-500 rounded-md p-2 text-white" : ""
        }`}
      >
        <Link href={`/hod`}>
          <a>
      ...
      <div
        className={`my-5 ${
          isActive(`/hod/user`) ? "bg-purple-500 rounded-md p-2 text-white" : ""
        }`}
      >
        <Link href={`/hod/user`}>
          <a>
      ...
      <div
        className={`my-5 ${
          isActive(`/hod/tgs`) ? "bg-purple-500 rounded-md p-2 text-white" : ""
        }`}
      >
        <Link href={`/hod/tgs`}>
          <a>
