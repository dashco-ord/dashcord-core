  ...
  return (
    <div
      className={`flex h-screen ${
        open ? "transition ease-in delay-100 w-64" : "w-24 items-center"
    ...
    >
      ...
      <div
        className={`my-4 ${
          isActive(`/`) ? "rounded-md bg-purple-500 p-1 text-white" : "hover:bg-purple-300 hover:rounded-md p-1"
        }`}
      >
        <Link href={`/`}>
      ...
      <div
        className={`my-4 ${
          isActive(`/user`) ? "rounded-md bg-purple-500 p-1 text-white" : "hover:bg-purple-300 hover:rounded-md p-1"
        } `}
      >
        <Link href={`/user`}>
          <a className="flex items-center">
      ...
      <div
        className={`my-4 ${
          isActive(`/goals`) ? "rounded-md bg-purple-500 p-1 text-white" : "hover:bg-purple-300 hover:rounded-md p-1"
        }`}
      >
        <Link href={`/goals`}>
          <a className="flex items-center">
      ...
      <div
        className={`my-4 ${
          isActive(`/meetings`) ? "rounded-md bg-purple-500 p-1 text-white" : "hover:bg-purple-300 hover:rounded-md p-1"
        }`}
      >
        <Link href={`/meetings`}>
          <a className="flex items-center">
      ...
      <div
        className={`my-4 ${
          isActive(`/events`) ? "rounded-md bg-purple-500 p-1 text-white" : "hover:bg-purple-300 hover:rounded-md p-1"
        }`}
      >
        <Link href={`/events`}>
          <a className="flex items-center">
      ...
      <div
        className={`my-4 mt-auto ${
          isActive(`/settings`) ? "rounded-md bg-purple-500 p-1 text-white" : "hover:bg-purple-300 hover:rounded-md p-1"
        }`}
      >
        <Link href={`/settings`}>
          <a className="flex items-center">
      ...
      <div
        className={`my-4 ${
          isActive("/logout") ? "rounded-md bg-purple-500 p-1 text-white" : "hover:bg-purple-300 hover:rounded-md p-1"
        }`}
      >
