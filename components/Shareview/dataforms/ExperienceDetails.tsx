    ...
    <div className='w-4/3' key={experience.id}>
      <div className='flex justify-center gap-10'>
        ...
        <div className='w-2/3'>
          ...
          {/* Comment Section */}
          <fieldset className="flex flex-col gap-2 items-start rounded mt-2 p-5 bg-white shadow-md">
              <h1 className="text-sm font-semibold bg-gray-500 text-white rounded-full p-1 px-3 w-fit">Comments</h1>
                ...
                <div className="flex my-0.5 gap-2 items-center">
                  <p className="text-sm font-semibold flex items-center">
                    ...
                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                      ...
                      Suchita Mishra <span className="text-blue-500">))</span>
                  </p>
                  <em className="text-sm mt-0.5">The syllabus you posted is outdated</em>
                  <a href="#" className="">
                    {/* delete svg */}
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                      viewBox="0 0 284.011 284.011" className="w-4 h-5">
              ...
              <div className="flex flex-col items-start rounded mt-2">
