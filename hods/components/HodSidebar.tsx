  ...
  return (
    <div className='flex flex-col pt-8 pb-5 items-center w-16 h-screen bg-white text-3xl px-7'>
      ...
      <div
        className={`my-5
         ${
           isActive(`/reports`) ? "bg-purple-500 rounded-md p-2 text-white" : ""
         }`}>
        <Link href={`/reports`}>
          <a>
            <svg
      ...
      <div
        className={`my-5 ${
          isActive(`/tgs`) ? "bg-purple-500 rounded-md p-2 text-white" : ""
        }`}>
        <Link href={`/tgs`}>
          <a>
            <svg
      ...
      <div
        className={`my-5 ${
          isActive(`/students`) ? "bg-purple-500 rounded-md p-2 text-white" : ""
        }`}>
        <Link href={`/students`}>
          <a>
            <svg
